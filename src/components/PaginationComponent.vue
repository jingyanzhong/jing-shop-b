  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
      <li class="page-item" :class="{'disabled' : !hasPre}">
        <a class="page-link" href="#" aria-label="Previous" @click.prevent="hasPreFn()">
          <span aria-hidden="true">&laquo;</span>
        </a>
      </li>
      <li class="page-item"  v-for="page in pagination.total_pages"
    :key="page">
        <a class="page-link" href="#" :class="{'active' : currentPage === page}" @click.prevent="nowPage(page)">{{ page }}</a>
      </li>
      <li class="page-item" :class="{'disabled' : !hasNext}">
        <a class="page-link" href="#" aria-label="Next" @click.prevent="hasNextFn()">
...
export default {
  ...
  methods: {
    ...
    disabled () {
      ...
      this.currentPage >= this.totalPage ? this.hasNext = false : this.hasNext = true
    },
    getProduct () {
